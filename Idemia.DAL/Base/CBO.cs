...
namespace Idemia.DAL.Base
{
    public static class CBO
    {
                ...
                if (propInfoList[i].PropertyInfo.CanWrite)
                {
                    ...
                    catch
                    {
                        ...
                        try
                        {
                            ...
                            {
                                propInfoList[i].PropertyInfo.SetValue(obj, Convert.ChangeType(value, Nullable.GetUnderlyingType(type)), null);
                            }
                            else
                            {
        ...
        public static T FillObject<T>(Type type, IDataReader dr) where T : class, new()
        {
            T obj = null;
            try
            {
        ...
        /// 
        public static List<T> FillCollection<T>(Type type, IDataReader dr) where T : class, new()
        {
